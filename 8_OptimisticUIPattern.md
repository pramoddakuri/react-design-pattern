...
<h3>Use Cases</h3>
<ul>
  <li>Real time interactions likes likes</li>
  <li>posting a msg and sending</li>
  <li>shopping cards add and remove instantli</li>
  <li>Colebartive editing in mails, xlsx</li>
  <li>Votings, polls</li>
</ul>

<h3>Pitfall</h3>
<ul>
  <li>Never assume that its always a success call, always plan for rollback for failure path.</li>
  <li>Dont rely much on optimistic to hide bad UX</li>
</ul>
